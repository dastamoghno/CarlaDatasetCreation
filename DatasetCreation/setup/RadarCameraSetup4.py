...
def radar_debug_color_for_name(name, num_radars=4):
    try:
        n = int(name.lstrip("R"))
        idx = (n - 1) % num_radars
    except:
...
def main():
    ...
    radar_positions = {
        ...
        "R2": make_transform(-33.825321, -74.745476, 13.0, 0.0, 180.0, 0.0),

        "R3": make_transform(3.355103, -52.015091, 13.0, 0.0, 0.0, 0.0),
        "R4": make_transform(3.355103, -74.745476, 13.0, 0.0, 180.0, 0.0),
    }

    # East column (R3/R4): flip R4 to the opposite ±40° side like upper-row flips in Setup8.
    flipped_40_deg_names = {"R4"}
